...
static final int ONE_GB = ONE_MB * 1024;
     ...
     */
    public static byte[] computeSHA256TreeHash(File inputFile, int chunkSize) throws IOException,
            NoSuchAlgorithmException {

        byte[][] chunkSHA256Hashes = getChunkSHA256Hashes(inputFile, chunkSize);
     ...
     */
    public static byte[][] getChunkSHA256Hashes(File file, int chunkSize) throws IOException,
            NoSuchAlgorithmException {
        ...
        try {
            ...
            while ((bytesRead = fileStream.read(buff, 0, chunkSize)) > 0) {
                md.reset();
